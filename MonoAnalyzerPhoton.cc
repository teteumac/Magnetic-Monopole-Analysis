...
void MonoCuts::doAnalysis_twotriggers(vector<MonoCandidate> &cand, vector<Photon> & pho, unsigned nCandidates,unsigned nPhoton, bool TRG1, bool TRG2, unsigned ev,bool matching_option,string year)
{
	...
	for(unsigned c=0;c<nCandidates;c++){
    	...
    	//cout << "TRG1: " << TRG1 << "and TRG2: " << TRG2 << endl;
...
void MonoAnalyzerPhoton(string year, string mass,bool matching_option, int sys_option=0)
{
	...
	if(sys_option == 0){
		...
		tree->Add(("/eos/home-m/matheus/magnetic_monopole_output_AOD/SpinHalf_PF_Merged_mass_" + mass + "_events_500_AOD.root").c_str());
		cout << "/eos/home-m/matheus/magnetic_monopole_output_AOD/SpinHalf_PF_Merged_mass_" + mass + "_events_500_AOD.root" <<  endl;
	...
	//TFile *oFile = new TFile(("/eos/home-m/matheus/SpinHalf_PhotonFusion"+year+"_"+mass+"_"+sys+"_"+matching+".root").c_str(),"recreate");
	TFile *oFile = new TFile(("/eos/home-m/matheus/SpinZero_DrellYan"+year+"_"+mass+"_"+sys+"_"+matching+".root").c_str(),"recreate");
	...
	// Test for the application of two triggers
	//MonoCuts noTrg_noTrg_TrgAnalysis("NOTRG_NOTRG",oFile);
	MonoCuts noTrg_Pho200_TrgAnalysis("NOTRG_HLTPhoton200",oFile);
	MonoCuts Pho200_PFMET_TrgAnalysis("HLTPhoton200_PFMET250",oFile);
	MonoCuts Pho200_CaloMET_TrgAnalysis("HLTPhoton200_CaloMET350",oFile);
	MonoCuts PFMET_CaloMET_TrgAnalysis("PFMET250_CaloMET350",oFile);
	...
	for(unsigned ev=0; ev<NEvents;ev++){
		...
		// Single Triggers with the default doAnalysis
		//noTrg_noTrg_TrgAnalysis.doAnalysis_twotriggers(cand,photon,nCandidates,nPhoton,true,true,ev,matching_option,year);
		noTrg_Pho200_TrgAnalysis.doAnalysis_twotriggers(cand,photon,nCandidates,nPhoton,true,passHLT_Photon200,ev,matching_option,year);                              // 2017, 2018
		Pho200_PFMET_TrgAnalysis.doAnalysis_twotriggers(cand,photon,nCandidates,nPhoton,passHLT_Photon200,passHLT_PFMET250_HBHECleaned,ev,matching_option,year);
		Pho200_CaloMET_TrgAnalysis.doAnalysis_twotriggers(cand,photon,nCandidates,nPhoton,passHLT_Photon200,passHLT_CaloMET350_HBHECleaned,ev,matching_option,year);
		PFMET_CaloMET_TrgAnalysis.doAnalysis_twotriggers(cand,photon,nCandidates,nPhoton,passHLT_PFMET250_HBHECleaned,passHLT_CaloMET350_HBHECleaned,ev,matching_option,year);
        ...
        HLT200_TrgAnalysis.doAnalysis(cand,photon,nCandidates,nPhoton,passHLT_Photon200,ev,matching_option,year);                       // 2017, 2018
		...
		// Two triggers
		//noTrg_noTrg_TrgAnalysis.WritePlots(oFile);
		noTrg_Pho200_TrgAnalysis.WritePlots(oFile);
		Pho200_PFMET_TrgAnalysis.WritePlots(oFile);
		Pho200_CaloMET_TrgAnalysis.WritePlots(oFile);
		PFMET_CaloMET_TrgAnalysis.WritePlots(oFile);
		

        // Extract the Signal Efficiency
        noTrgAnalysis.SignalEff("NoTRG",NEvents);
        noTrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"NoTrg");

		//noTrg_noTrg_TrgAnalysis.SignalEff("NOTRG_NOTRG",NEvents);
		//noTrg_noTrg_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/t/tmenezes/work/private/output_MonoAnalyzerPhoton/csv_file/Signaleff_"+year+"_"+mass+"_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"NoTrg_NoTrg");

		noTrg_Pho200_TrgAnalysis.SignalEff("NOTRG_Photon200",NEvents);
		noTrg_Pho200_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"NoTrg_Pho200");
        ...
        HLT175_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_HLT_175_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"Photon175");

        HLT200_TrgAnalysis.SignalEff("HLT_Photon200",NEvents);
        HLT200_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_HLT_200_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"Photon200");
		...
		PFMET_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_HLT_PFMET250_HBHECleaned_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"HLT_PFMET250_HBHECleaned");

        CaloMET_TrgAnalysis.SignalEff("HLT_CaloMET350_HBHECleaned",NEvents);
		CaloMET_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_HLT_CaloMET350_HBHECleaned_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"HLT_CaloMET350_HBHECleaned"); 


		noTrg_Pho200_TrgAnalysis.SignalEff("NOTRG_HLTPhoton200",NEvents);
		noTrg_Pho200_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_NoTRG_HLTPhoton200_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"NoTRG_HLT_Photon200");

		Pho200_PFMET_TrgAnalysis.SignalEff("HLTPhoton200_PFMET250",NEvents);
		Pho200_PFMET_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_HLTPhoton200_PFMET_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"HLT_Photon200_PFMET");

		Pho200_CaloMET_TrgAnalysis.SignalEff("HLTPhoton200_CaloMET350",NEvents);
		Pho200_CaloMET_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_HLTPhoton200_CaloMET_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"HLT_Photon200_CaloMET");


		PFMET_CaloMET_TrgAnalysis.SignalEff("PFMET250_CaloMET350",NEvents);
		PFMET_CaloMET_TrgAnalysis.SaveAs_csv(("/afs/cern.ch/user/m/matheus/CMSSW_10_6_24/src/csv_file/Signaleff_SpinZeroDY_"+year+"_"+mass+"_HLTPFMET_CaloMET_"+sys+"_"+matching+".csv").c_str(),NEvents,mass,"HLT_PFMET_CaloMET");
