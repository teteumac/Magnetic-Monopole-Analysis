...
private:
  ...
  //  number of cuts
  static const unsigned nCuts_ = 4U; // quality cuts + 3 analysis cuts
...
const double MonoCutFlow::eCut_ = 50.;
const double MonoCutFlow::f51Cut_ = 0.95;
const double MonoCutFlow::dEdXSigCut_ = 8;
...
int main ( int argc, char **argv ) {
  ...
  trigNameList.push_back("HLT_Photon36_R9Id85_OR_CaloId10_Iso50_Photon22_R9Id85_OR_CaloId10_Iso50_v5");
